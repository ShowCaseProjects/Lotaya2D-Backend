...
export class PaymentmethodController {
    ...
    deleteUserPaymentMethod(@Param() paymentReqPath: UserPaymentDeleteReqPathDto,@Body() paymentReqBody:UserPaymentDeleteReqBodyDto): Promise<UserPaymentUpdateResBodyDto> {
