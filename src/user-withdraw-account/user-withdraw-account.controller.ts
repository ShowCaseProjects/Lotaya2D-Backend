...
export class UserWithdrawAccountController {
    ...
    @ApiOperation({
        ...
        description: 'Withdraw Account to get money from gaining from game with authentication'
    })
    @ApiOkResponse({
        description: 'To send success response to be authenticated user.',
        type: UserWithdrawAccountInsertResBodyDto
    })
    addUserWithdrawAccountMethod(@Param() userWithdrawAccountReqPath: UserWithdrawAccountInsertReqPathDto,@Body() userWithdrawAccountReqBody:UserWithdrawAccountInsertReqBodyDto): Promise<UserWithdrawAccountInsertResBodyDto> {
        return this.userWithdrawAccount.addUserWithdraw(userWithdrawAccountReqPath,userWithdrawAccountReqBody);
    }
    ...
    updateUserWithdrawAccountMethod(@Param() userWithdrawAccountReqPath: UserWithdrawAccountUpdateReqPathDto,@Body() userWithdrawAccountReqBody:UserWithdrawAccountUpdateReqBodyDto): Promise<UserWithdrawAccountUpdateResBodyDto> {
        return this.userWithdrawAccount.updateUserWithdrawAccount(userWithdrawAccountReqPath,userWithdrawAccountReqBody);
    }
    ...
    deleteUserWithdrawAccountMethod(@Param() userWithdrawAccountReqPath: UserWithdrawAccountDeleteReqPathDto,@Body() userWithdrawAccountReqBody:UserWithdrawAccountDeleteReqBodyDto): Promise<UserWithdrawAccountUpdateResBodyDto> {
        return this.userWithdrawAccount.deleteUserWithdrawAccount(userWithdrawAccountReqPath,userWithdrawAccountReqBody);
    }
