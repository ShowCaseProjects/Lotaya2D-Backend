...
export class AuthController {
  ...
  signIn(
    @Param() phoneNumber: LoginUserPhoneNumberConfirmReqPathDto,
    @Param() password: LoginUserPasswordConfirmReqBodyDto,
  ): Promise<LoginUserOtpCodeConfirmResBodyDto> {
  ...
  adminUserSignIn(
    @Body() adminUserLoginReqBodyDto: LoginAdminUserReqBodyDto,
