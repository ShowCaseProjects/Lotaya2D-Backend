...
export class UserWithdrawMethodFindReqQueryDto {
  ...
  @Matches(/^[/^[a-zA-Z0-9- _]+$/, {
    context: {
      errorCode: 'E1000',
      errorMessage:
        'Please enter your withdraw type as alphanumeric character.',
    },
  })
  @IsOptional()
  @ApiPropertyOptional()
  ...
  @Length(6, 6, {
    context: {
      errorCode: 'E1000',
      errorMessage:
        'Please enter your withdraw confirmation code using 6 digits.',
    },
  })
  @IsOptional()
  @ApiPropertyOptional()
  ...
  @Length(1, 1, {
    context: {
      errorCode: 'E1000',
      errorMessage:
        'Please enter your withdraw confirmation status using 1 digits.',
    },
  })
  @IsOptional()
  @ApiPropertyOptional()
