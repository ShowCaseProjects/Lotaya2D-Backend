...
export class ReceiverAccountController {
    ...
    addAdminReceiverAccountMethod( @Body() accountReqBody: AdminAccountInsertReqBodyDto): Promise<AdminAccountInsertResBodyDto> {
    ...
    updateAdminReceiverAccountMethod(@Param() accountReqPath: AdminReceiverAccountUpdateReqPathDto, @Body() accountReqBody:AdminReceiverAccountUpdateReqBodyDto): Promise<AdminReceiverAccountUpdateResBodyDto> {
