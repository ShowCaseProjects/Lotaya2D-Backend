...
export class AdminReceiverAccountUpdateReqPathDto {
  @IsNotEmpty({
    context: {
      errorCode: 'E1000',
...
export class AdminReceiverAccountUpdateReqBodyDto {
  @IsNotEmpty({
    context: {
      errorCode: 'E1000',
      errorMessage: 'Please enter your ID.',
  ...
  @Matches(/^[/^[a-zA-Z0-9- _]+$/, {
    context: {
      errorCode: 'E1000',
      errorMessage:
        'Please enter your  account name as alphanumeric character.',
    },
  })
  @IsNotEmpty({
    context: {
...
export class AdminReceiverAccountUpdateResBodyDto {
  @ApiProperty()
  isSuccess: boolean;
}
